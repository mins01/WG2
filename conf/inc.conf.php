...
$_WG2_CFG['allowExt'] = 'png,gif,jpg,jpeg,webp,wcbjson,json'; //이 확장자만 보인다. *이 있다면 모든 파일이 보인다.
$_WG2_CFG['upload_allowExt'] = 'png,gif,jpg,jpeg,webp,wcbjson,json'; //업로드 가능 확장자
$_WG2_CFG['upload_file_accept'] = '.png,.gif,.jpg,.jpeg,webp,.wcbjson,.json'; //업로드용 input file에서 보이는 확장자 및 타입
